...
THEMES = {
    "light": dict(
        ...
        layer="#3d2a52", mod="#4a3410", magic="#4a1f3a", system="#123a3c",
        dead="#232327",
        alpha_t="#f2f2f4", punct_t="#8ecbff", trainer_t="#63636b", gate_t="#8ff0cd",
        layer_t="#d3aaff", mod_t="#ffcf7a", magic_t="#ff9ed3", system_t="#7fe6e0",
        dead_t="#5a5a63",
        ghost="#55555e",
    ),
    "dark": dict(
        ...
        layer="#2c1f3c", mod="#372709", magic="#361528", system="#0d2b2d",
        dead="#161619",
        alpha_t="#ececf0", punct_t="#7cc0f8", trainer_t="#5c5c64", gate_t="#79dfbc",
        layer_t="#c39cf5", mod_t="#f0be6b", magic_t="#f78ac4", system_t="#6fd8d2",
        dead_t="#4c4c55",
        ghost="#4a4a53",
    ),
}
