...
THEMES = {
    "light": dict(
        ...
        layer="#3d2a52", mod="#4a3410", system="#123a3c",
        dead="#232327",
        alpha_t="#f2f2f4", punct_t="#8ecbff", trainer_t="#63636b", gate_t="#8ff0cd",
        layer_t="#d3aaff", mod_t="#ffcf7a", system_t="#7fe6e0",
        dead_t="#5a5a63",
        ghost="#55555e",
    ),
    "dark": dict(
        ...
        layer="#2c1f3c", mod="#372709", system="#0d2b2d",
        dead="#161619",
        alpha_t="#ececf0", punct_t="#7cc0f8", trainer_t="#5c5c64", gate_t="#79dfbc",
        layer_t="#c39cf5", mod_t="#f0be6b", system_t="#6fd8d2",
        dead_t="#4c4c55",
        ghost="#4a4a53",
    ),
}
